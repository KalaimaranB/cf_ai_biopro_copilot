export const THEME = {
  BG_DARKEST: "#0d1117", BG_DARK: "#161b22", BG_MEDIUM: "#21262d", BG_LIGHT: "#30363d",
  FG_PRIMARY: "#c9d1d9", FG_SECONDARY: "#8b949e", BORDER: "#30363d",
  ACCENT_PRIMARY: "#2f81f7", ACCENT_DANGER: "#f85149", DNA_PRIMARY: "#00f2ff",
};

export const Icons = {
  Mic: () => <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M12 2a3 3 0 0 0-3 3v7a3 3 0 0 0 6 0V5a3 3 0 0 0-3-3z"/><path d="M19 10v2a7 7 0 0 1-14 0v-2"/><line x1="12" y1="19" x2="12" y2="22"/></svg>,
  ...
  Notebook: () => <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"/><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"/></svg>,
